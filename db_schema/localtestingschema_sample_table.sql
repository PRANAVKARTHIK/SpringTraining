...
CREATE TABLE `sample_table` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Just for testing the workbench';
...
INSERT INTO `sample_table` VALUES (0,'pranav','brilliant');
